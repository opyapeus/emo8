...
(function(exports) {
  ...
  var walls = [ Emo8_Data_Emoji.waterWave, Emo8_Data_Emoji.evergreenTree, Emo8_Data_Emoji.deciduousTree, Emo8_Data_Emoji.mountain, Emo8_Data_Emoji.mountFuji, Emo8_Data_Emoji.cloudWithLightning, Emo8_Data_Emoji.tornado, Emo8_Data_Emoji.fire ];
...
(function(exports) {
  ...
  var isOutOfMonitor = function (ms) {
      return function (size) {
          return function (x) {
              return function (y) {
                  return ((x + size | 0) - 1 | 0) < 0 || (x > ms.width || (((y + size | 0) - 1 | 0) < 0 || y > ms.height));
              };
          };
      };
  };
  var isMonitorCollide = function (ms) {
      return function (size) {
          return function (x) {
              return function (y) {
                  return x < 0 || (((x + size | 0) - 1 | 0) > ms.width || (y < 0 || ((y + size | 0) - 1 | 0) > ms.height));
              };
          };
      };
  };
...
(function(exports) {
  ...
  var isOut = function (size) {
      return function (v) {
          return Emo8_Utils.isOutOfMonitor(Emo8_Utils.defaultMonitorSize)(size)(v.x)(v.y);
      };
  };
  ...
  var isCollWorld = function (size) {
      return function (v) {
          return Emo8_Utils.isMonitorCollide(Emo8_Utils.defaultMonitorSize)(size)(v.x)(v.y);
      };
  };
  var isCollMap = function (mId) {
      return function (mSize) {
          return function (size) {
              return function (v) {
                  return Emo8_Action_Update.isMapCollide(mId)(mSize)(Asset.walls)(size)(v.x)(v.y);
              };
          };
      };
  };
  var isColl = function (sizeA) {
      return function (pA) {
          return function (sizeB) {
              return function (pB) {
                  return Emo8_Utils.isCollide(sizeA)(pA.x)(pA.y)(sizeB)(pB.x)(pB.y);
              };
          };
      };
  };
  ...
  var objectDrawBullet = new Class_Object.ObjectDraw(function () {
      ...
      var emoF = (function () {
          if (o instanceof Normal) {
              return Emo8_Action_Draw.emo;
          };
          if (o instanceof Upper) {
              return Emo8_Action_Draw.emor(30);
          };
          if (o instanceof Downer) {
              return Emo8_Action_Draw.emor(-30 | 0);
          };
          throw new Error("Failed pattern match at Data.Bullet (line 27, column 20 - line 30, column 42): " + [ o.constructor.name ]);
      })();
      return emoF(Emo8_Data_Emoji.spiderWeb)(Class_Object.size(objectBullet)(o))((Class_Object.position(objectBullet)(o)).x)((Class_Object.position(objectBullet)(o)).y);
  });
  exports["Normal"] = Normal;
  exports["Upper"] = Upper;
...
(function(exports) {
  ...
  var objectDrawEnemyBullet = new Class_Object.ObjectDraw(function () {
      ...
      if (v instanceof NormalBull) {
          return Emo8_Action_Draw.emor(-40 | 0)(Emo8_Data_Emoji.pushpin)(Class_Object.size(objectEnemyBullet)(v))((Class_Object.position(objectEnemyBullet)(v)).x)((Class_Object.position(objectEnemyBullet)(v)).y);
      };
      if (v instanceof ParseBull) {
          return Emo8_Action_Draw.emor(10 * v.value0.t | 0)(Emo8_Data_Emoji.hammer)(Class_Object.size(objectEnemyBullet)(v))((Class_Object.position(objectEnemyBullet)(v)).x)((Class_Object.position(objectEnemyBullet)(v)).y);
      };
...
(function(exports) {
  ...
  var objectDrawPlayer = new Class_Object.ObjectDraw(function () {
      ...
      return emoF(Emo8_Data_Emoji.helicopter)(Class_Object.size(objectPlayer)(v))((Class_Object.position(objectPlayer)(v)).x)((Class_Object.position(objectPlayer)(v)).y);
  });
  var initialPlayer = new Player({
      pos: {
          x: 0,
          y: Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(Emo8_Utils.defaultMonitorSize.height)(2)
      },
      energy: 30,
      appear: Stable.value
  });
...
(function(exports) {
  ...
  var objectDrawEnemy = new Class_Object.ObjectDraw(function () {
      ...
      if (v instanceof Invader) {
          return Emo8_Action_Draw.emo(Emo8_Data_Emoji.alienMonster)(Class_Object.size(objectEnemy)(v))((Class_Object.position(objectEnemy)(v)).x)((Class_Object.position(objectEnemy)(v)).y);
      };
      if (v instanceof Moi) {
          return Emo8_Action_Draw.emo(Emo8_Data_Emoji.moai)(Class_Object.size(objectEnemy)(v))((Class_Object.position(objectEnemy)(v)).x)((Class_Object.position(objectEnemy)(v)).y);
      };
      if (v instanceof Bee) {
          return Emo8_Action_Draw.emo(Emo8_Data_Emoji.honeybee)(Class_Object.size(objectEnemy)(v))((Class_Object.position(objectEnemy)(v)).x)((Class_Object.position(objectEnemy)(v)).y);
      };
      if (v instanceof Rex) {
          return Emo8_Action_Draw.emo(Emo8_Data_Emoji.tRex)(Class_Object.size(objectEnemy)(v))((Class_Object.position(objectEnemy)(v)).x)((Class_Object.position(objectEnemy)(v)).y);
      };
      if (v instanceof Oct) {
          return Emo8_Action_Draw.emo(Emo8_Data_Emoji.octopus)(Class_Object.size(objectEnemy)(v))((Class_Object.position(objectEnemy)(v)).x)((Class_Object.position(objectEnemy)(v)).y);
      };
  ...
  var emergeTable = function (v) {
      if (v === 200) {
          return [ new Invader({
              pos: {
                  x: Emo8_Utils.defaultMonitorSize.width,
                  y: 250
              }
          }) ];
      };
  ...
  var updateEnemy = function (v) {
      return function (v1) {
          ...
          if (v1 instanceof Moi) {
              return Moi.create((function () {
                  ...
                  if ($34) {
                      return {
                          pos: {
                              x: v1.value0.pos.x - 2 | 0,
                              y: v1.value0.pos.y - 2 | 0
                          },
          ...
          if (v1 instanceof Rex) {
              return Rex.create((function () {
                  ...
                  if ($37) {
                      return {
                          pos: {
                              x: v1.value0.pos.x - Constants.speed | 0,
          ...
          if (v1 instanceof Oct) {
              var dx = (function () {
                  var $40 = v1.value0.pos.x > Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(Emo8_Utils.defaultMonitorSize.width)(2);
                  if ($40) {
                      return -Constants.speed | 0;
                  };
                  return 0;
              })();
              return Oct.create({
...
(function(exports) {
  ...
  var objectDrawParticle = new Class_Object.ObjectDraw(function () {
      ...
      return Emo8_Action_Draw.emo(Emo8_Data_Emoji.globeWithMeridians)(Class_Object.size(objectParticle)(o))((Class_Object.position(objectParticle)(o)).x)((Class_Object.position(objectParticle)(o)).y);
  });
...
(function(exports) {
  ...
  var mapTileInMonitor = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(Emo8_Utils.defaultMonitorSize.width)(Constants.mapSize);
  ...
  var drawScrollMap = function (distance) {
      var drawCond = function (mId) {
          return function (num) {
              return function (d) {
                  var base = num * mapWidth | 0;
                  return Control_Applicative.when(Control_Monad_Free.freeApplicative)((base - (Constants.mapSize * mapTileInMonitor | 0) | 0) <= d && d < (base + mapWidth | 0))(Emo8_Action_Draw.emap(mId)(Constants.mapSize)(base - d | 0)(0));
              };
          };
      };
  ...
  var beInMonitor = function (p) {
      return function (v) {
          ...
          var npy = (function () {
              ...
              if (isCollY && !v1) {
                  return Emo8_Utils.defaultMonitorSize.height - size$prime | 0;
              };
              return npos.y;
          })();
          ...
          var npx = (function () {
              ...
              if (isCollX && !v1) {
                  return Emo8_Utils.defaultMonitorSize.width - size$prime | 0;
              };
              return npos.x;
          })();
...
(function(exports) {
  ...
  var gameState = new Emo8_Class_Game.Game(function (v) {
      if (v instanceof TitleState) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw.cls(Emo8_Data_Color.Aqua.value))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw["emor'"](30)(Emo8_Data_Emoji.helicopter)(192)(50)(50))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw.emo(Emo8_Data_Emoji.spiderWeb)(256)(200)(200))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw.emor(-15 | 0)(Emo8_Data_Emoji.octopus)(128)(300)(300))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw.emo(Emo8_Data_Emoji.pill)(64)(150)(400))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw.emor(75)(Emo8_Data_Emoji.pill)(64)(100)(300))(function () {
                                  return Emo8_Action_Draw.emo(Emo8_Data_Emoji.fastForwardButton)(64)(350)(100);
                              });
                          });
                      });
                  });
      ...
      if (v instanceof OverState) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw.cls(Emo8_Data_Color.Maroon.value))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw.emo(Emo8_Data_Emoji.hole)(256)(125)(150))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw.emor(160)(Emo8_Data_Emoji.helicopter)(128)(175)(200))(function () {
                      return Emo8_Action_Draw.emo(Emo8_Data_Emoji.recyclingSymbol)(128)(185)(350);
                  });
              });
          });
      };
      if (v instanceof ClearState) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw.cls(Emo8_Data_Color.Lime.value))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw.emor(15)(Emo8_Data_Emoji.helicopter)(64)(350)(400))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw.emor(-15 | 0)(Emo8_Data_Emoji.octopus)(128)(175)(175))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Free.freeBind)(Emo8_Action_Draw.emo(Emo8_Data_Emoji.globeWithMeridians)(256)(75)(75))(function () {
                          return Emo8_Action_Draw.emo(Emo8_Data_Emoji.thumbsUp)(64)(100)(400);
                      });
                  });
              });
          });
      ...
      throw new Error("Failed pattern match at Emodius (line 39, column 1 - line 39, column 33): " + [ v.constructor.name ]);
  }, function (v) {
      ...
      return function (v) {
          if (v instanceof TitleState) {
              return Control_Applicative.pure(Control_Monad_Free.freeApplicative)((function () {
                  var $15 = Emo8_Input.isCatchAny(input);
                  if ($15) {
          ...
          if (v instanceof OverState) {
              return Control_Applicative.pure(Control_Monad_Free.freeApplicative)((function () {
                  var $16 = Emo8_Input.isCatchAny(input);
                  if ($16) {
                      return initialState;
                  };
          ...
          if (v instanceof ClearState) {
              return Control_Applicative.pure(Control_Monad_Free.freeApplicative)((function () {
                  var $17 = Emo8_Input.isCatchAny(input);
                  if ($17) {
                      return initialState;
                  };
          ...
          if (v instanceof PlayState) {
              ...
              return Control_Bind.bind(Control_Monad_Free.freeBind)(Helper.isCollideScrollMap(Data_Player.objectPlayer)(v.value0.distance)(np))(function (v1) {
                  ...
                  return Control_Applicative.pure(Control_Monad_Free.freeApplicative)((function () {
                      ...
                      throw new Error("Failed pattern match at Emodius (line 84, column 16 - line 94, column 18): " + [ isGameClear.constructor.name, isGameOver.constructor.name ]);
                  })());
              });
          };
          throw new Error("Failed pattern match at Emodius (line 39, column 1 - line 39, column 33): " + [ input.constructor.name, v.constructor.name ]);
      };
  });
  var main = function __do() {
      var v = Emo8_Utils.mkAsset([ Asset.map0, Asset.map1, Asset.map2, Asset.map3 ])([  ])();
      return Emo8.emo8(gameState)(initialState)(v)(Emo8_Utils.defaultMonitorSize)();
  };
